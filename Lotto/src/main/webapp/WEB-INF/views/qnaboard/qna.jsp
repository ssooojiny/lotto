 ...
 td {
  ...
  #topMenu {            
                ...
                #topMenu .menuLink:hover {            
                  ...
                  .imge {
        position: relative;
        background-image: url("/lotto/resources/images/blue_background.jpg");                                                               
        height: 28vh;
...
<table>
  ...
  <tr>
  <td>${vo.qna_bno}</td>
   <td><a class="goToDetail" href="${vo.qna_bno }">${vo.qna_title}</a></td>
    <td>${vo.qna_userid}</td>
    <fmt:formatDate  value="${vo.qna_regdate }"
