...
<body>
 ...
 <div class="content_wrap">
    ...
    <div class="content">
      <div class="centermenu">
        <table width="745" border="0" cellspacing="0" cellpadding="0" align="center">
          <tbody>
            <tr>
              <td><img src="/lotto/resources/image/banner2.png"
                width="750px" height="300px"></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
                              ...
                              <td>
                                <div style="width: 501px; height: 580px; overflow: auto; overflow-x: hidden; overflow-y: auto; 
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" border="0" class="table">
                                    <tbody>
                                      <c:forEach var="vo" items="${lose_list }" begin="0" step="1" varStatus="status" end="45">
  ...
  <script type="text/javascript">
      var selected_lose_num = new Array(0);
          ...
          .on(
              {
                click : function() { // 이미지 선택시 색 변하기, 배열에 추가하기, 선택숫자 이미지 띄우기
                  ...
                  if ($(this).attr("src").match('on')) {
                    ...
                    selected_lose_num.splice(selected_num.indexOf(id), 1); //배열에서 지우기
                  ...
                  for (var i = 0; i < sel_num.length; i++) {
                    ...
                    console.log("selected_num[" + i + "] : " + selected_lose_num[i]);
      ...
      $('#btn_select').on({ //선택 버튼
        ...
        click : function() {
          ...
          console.log(selected_lose_num); //배열 확인
          ...
          if (sel_cnt < 6) {
            ...
            $.ajax({
              ...
              dataType : 'json',
              data : {
                'selected_lose_num' : selected_lose_num
              },
